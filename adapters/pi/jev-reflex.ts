...
export default function (pi: ExtensionAPI) {
  pi.registerTool(defineTool({
    ...
    parameters: Type.Object({
      method: Type.Union(['status','batch','shared','bulk','inspect_job','cancel_job','controller_open','controller_event','controller_inspect','recipe','context','record_outcome','metrics'].map(x => Type.Literal(x))),
